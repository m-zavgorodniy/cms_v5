...
--
-- Хост: 127.0.0.1
-- Время создания: Сен 16 2016 г., 01:31
...
(6, '', '', 24, '', 'Текст над формой', '', '<div>форма, такая же, как в бронировании офисов, только на всю ширину - см. <a href="http://x87ryn.axshare.com/#p=request">http://x87ryn.axshare.com/#p=request</a></div>\r\n<div> </div>', NULL, NULL, 10, 1);
...
('g7fdlpi16h1if3tvsr0kh1csk2', '', 1, 1, '127.0.0.1', '2016-09-16 00:23:21', '2016-09-16 00:23:21');
