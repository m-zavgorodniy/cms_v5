...
--
-- Хост: 127.0.0.1
-- Время создания: Авг 01 2016 г., 06:22
...
('special_offer', 'special_offer', 0, 0, 'Спецпредложение', 1, 1, 1, 0, 0, 0, 0, 0, NULL, 'Спецпредложения', 'Добавить предложение', 'предложение', 0, 1, NULL, NULL, NULL, 0, NULL, 'date_from DESC'),
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3971 ;
...
INSERT INTO `office_center_room` (`id`, `meta_table_id`, `office_center_id`, `service_group_id`, `title`, `title_en`, `number`, `seats_num`, `floor_area_m2`, `price`, `price_bonus`, `price_bonus_en`, `img_src_big`, `img_src`, `annotation`, `annotation_en`, `sort_num`, `published`) VALUES
(1, '', 5, 1, 'Офис №21', '', 0, 4, '21.00', 15990, NULL, NULL, '/uploads/images/office_centers/arma/gallery/13_MOR_5934_1.jpg', '/uploads/images/office_centers/arma/gallery/.resize/13_MOR_5934_1.175x100.jpg', NULL, NULL, 20, 1),
(2, '', 5, 1, 'Офис №24', '', 0, 3, '15.00', 17990, '+ 4 часа переговорных', NULL, '/uploads/images/office_centers/arma/gallery/11_MOR_5985-Edit-Edit.jpg', '/uploads/images/office_centers/arma/gallery/.resize/11_MOR_5985-Edit-Edit.175x100.jpg', NULL, NULL, 30, 1),
(3, '', 5, 1, 'Офис №13', '', 0, 8, '64.00', 9990, NULL, NULL, '/uploads/images/office_centers/arma/gallery/06_MOR_5979.jpg', '/uploads/images/office_centers/arma/gallery/.resize/06_MOR_5979.175x100.jpg', NULL, NULL, 10, 1),
(4, '', 5, 4, 'Переговорная', '', 0, 8, '15.00', 700, NULL, NULL, '/uploads/images/office_centers/arma/gallery/21_MOR_5963.jpg', '/uploads/images/office_centers/arma/gallery/.resize/21_MOR_5963.175x100.jpg', NULL, NULL, 110, 1),
(6, '', 5, 3, 'Виртуальный офис', '', 0, NULL, NULL, 4490, NULL, NULL, NULL, NULL, '<p>Это московский телефонный номер для Вашей компании и обработка входящих звонков «живым» секретарем. </p>', NULL, 80, 1),
(7, '', 5, 3, 'Виртуальный офис +', '', 0, NULL, NULL, 7490, NULL, NULL, NULL, NULL, '<p>Тариф предоставляет Вашей компании почтовый адрес в современном БЦ, московский телефонный номер и обработка входящих звонков «живым» секретарем.</p>', NULL, 90, 1),
(8, '', 5, 3, 'Виртуальный офис +  юридический адрес', '', 0, NULL, NULL, 9400, NULL, NULL, NULL, NULL, '<p>Это предоставление для Вашей компании единого юридического (для регистрации в ИФНС) и почтового адреса в современном БЦ, московского телефонного номера и обработка входящих звонков «живым» секретарем.</p>', NULL, 100, 1),
(9, '', 5, 2, 'Постоянный', '', 0, NULL, NULL, 15490, NULL, NULL, NULL, NULL, '<ul>\r\n    <li>Незакреплённое рабочее место</li>\r\n    <li>4 часа переговорной комнаты в неделю</li>\r\n    <li>Личный ящик</li>\r\n    <li>Возможность заморозить абонемент на 2 недели</li>\r\n    <li>Скидка 11% при покупке тарифа более, чем на 2 месяца</li>\r\n    <li>Бесплатный доступ на все мероприятия коворкинга в течение месяца</li>\r\n</ul>', NULL, 40, 1),
(10, '', 5, 2, 'Динамический', '', 0, NULL, NULL, 8800, NULL, NULL, NULL, NULL, '<ul>\r\n    <li>Незакреплённое рабочее место</li>\r\n    <li>4 часа переговорной комнаты в неделю</li>\r\n    <li>Личный ящик</li>\r\n</ul>', NULL, 50, 1),
(11, '', 5, 2, '1 неделя  в месяц', '', 0, NULL, NULL, 5400, NULL, NULL, NULL, NULL, '<ul>\r\n    <li>Незакреплённое рабочее место</li>\r\n    <li>4 часа переговорной комнаты в неделю</li>\r\n    <li>Личный ящик</li>\r\n</ul>', NULL, 60, 1),
(13, '', 5, 3, 'Почтовый адрес', '', 0, NULL, NULL, 3490, NULL, NULL, NULL, NULL, '<p>Предоставляет для вашей компании почтовый адрес  для приема почтовой корреспонденции в современном БЦ.</p>', NULL, 70, 1);
...
('lih7e9r1to0dteiias8jj1mat3', '', 1, 1, '127.0.0.1', '2016-08-01 05:12:35', '2016-08-01 05:12:35');
