...
--
-- Хост: 127.0.0.1
-- Время создания: Сен 05 2016 г., 07:49
...
('office_center_room', 'office_center_room', 0, 0, 'Объект заказа', 1, 1, 1, 0, 0, 0, 1, 0, 'service_group_id <> 3', 'Объекты заказа в БЦ', 'Добавить объект заказа', NULL, 0, 1, NULL, NULL, NULL, 0, 'office_center_room.published <> 0 AND (office_center_room.office_center_id = {center} OR office_center_room.office_center_id IS NULL) AND office_center_room.service_group_id = {service}', NULL),
...
(4, '', 5, 4, NULL, 'Переговорная', '', 0, 8, '15.00', 700, '420 - после 1 часа аренды', NULL, '/uploads/images/office_centers/arma/gallery/21_MOR_5963.jpg', '/uploads/images/office_centers/arma/gallery/.resize/21_MOR_5963.175x100.jpg', NULL, NULL, 110, 1),
...
('1epagoie5mmskcqqua3b36gds7', '', 1, 1, '127.0.0.1', '2016-09-04 15:49:45', '2016-09-04 15:49:45');
