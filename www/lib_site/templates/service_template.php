<?
	...
	if ('POST' == $_SERVER['REQUEST_METHOD']) {
		...
		if (!($manager_email = $_DATA['office_center']['items'][$g_office_center_id]['email_request']) ||
			$MY_POST['form_type'] == 'book_virtualoffice') {

			$manager_email = $_SITE['settings']['email_request'];
		}
...
/*			$vd_send_form_manager_message_text .= "\r\nДанные объекта";*/
			...
			$vd_send_form_manager_message_text .= "\r\nОфис номер: " . $MY_POST['office_number'];
/*			$vd_send_form_manager_message_text .= "\r\nПлощадь: " . $MY_POST['office_area'];
			...
			$vd_send_form_customer_message_text .= "Здравствуйте, " . $vd_send_form_name . "\r\n\r\nВаша заявка на предварительный просмотр офиса принята.\r\nДля подтверждения заявки наш менеджер свяжется с Вами в рабочее время по будням с 10.00 до 19.00";
...
/*			$vd_send_form_customer_message_text .= "\r\nПлощадь: " . $MY_POST['office_area'];
			...
			if ($vd_send_form_message != "") {
				$vd_send_form_manager_message_text .= "\r\n\r\nСообщение клиента:\r\n$vd_send_form_message";
				$vd_send_form_customer_message_text .= "\r\n\r\nВаше сообщение:\r\n$vd_send_form_message";
			}
			
			if (true === mail_send($manager_email, 'Заявка на просмотр офиса', $vd_send_form_manager_message_text)) {
				mail_send($MY_POST['email'], 'Ваша заявка принята', 
					strip_tags(htmlspecialchars_decode($vd_send_form_customer_message_text)) . "\r\n\r\n\r\n\r\n" .
					htmlspecialchars_decode($_SITE['settings']['client_email_footer']));
				echo 'Спасибо, ваша заявка на предварительный просмотр офиса принята.';
			...
			$vd_send_form_manager_message_text .= "\r\nКлиент бронирует";
			$vd_send_form_manager_message_text .= "\r\nОфис номер: " . $MY_POST['office_number'];
			$vd_send_form_manager_message_text .= "\r\nВ бизнес-центре: " . $MY_POST['business_center'];
/*			$vd_send_form_manager_message_text .= "\r\nПлощадь: " . $MY_POST['office_area'];
			$vd_send_form_manager_message_text .= "\r\nРабочих мест: " . $MY_POST['office_seats_num'];
			$vd_send_form_manager_message_text .= "\r\nСтоимость: " . $MY_POST['office_cost_seat'];
			$vd_send_form_manager_message_text .= "\r\nИтого: " . $MY_POST['office_cost_total'];*/
			...
			$vd_send_form_customer_message_text .= "Здравствуйте, " . $vd_send_form_name . "\r\n\r\nВаша заявка на бронирование офиса принята.\r\nДля подтверждения бронирования наш менеджер свяжется с Вами в рабочее время по будням с 10.00 до 19.00";
...
/*			$vd_send_form_customer_message_text .= "\r\n\r\nОбратите внимание! Бронь сохраняется до вечера " . $vd_send_form_customer_message_tomorrow->format('d.m.Y');*/

			if (true === mail_send($manager_email, 'Заявка на бронирование офиса', $vd_send_form_manager_message_text)) {
				mail_send($MY_POST['email'], 'Ваша заявка принята',
					strip_tags(htmlspecialchars_decode($vd_send_form_customer_message_text)) . "\r\n\r\n\r\n\r\n" .
					htmlspecialchars_decode($_SITE['settings']['client_email_footer']));
				echo 'Спасибо, ваша заявка на бронирование офиса принята.';
			...
			$vd_send_form_manager_message_text .= "Здравствуйте,\r\n\r\nНа сайте была оформлена новая заявка на услуги виртуального офиса.";
			
			$vd_send_form_manager_message_text .= "\r\n";
			
			$vd_send_form_manager_message_text .= "\r\nКлиент бронирует: " . $MY_POST['virtual_office_rate'];
			$vd_send_form_manager_message_text .= "\r\nНа срок: " . $MY_POST['term'];
			$vd_send_form_manager_message_text .= "\r\nВ бизнес-центре: " . $MY_POST['business_center'];
/*			$vd_send_form_manager_message_text .= "\r\nСтоимость: " . $MY_POST['virtual_office_price'];*/
			...
			$vd_send_form_customer_message_text .= "Здравствуйте,\r\n\r\nВаша заявка на услуги виртуального офиса принята.";
			
			$vd_send_form_customer_message_text .= "\r\n";
			
			$vd_send_form_customer_message_text .= "\r\nВы бронируете: "  . $MY_POST['virtual_office_rate'];
			$vd_send_form_customer_message_text .= "\r\nНа срок: " . $MY_POST['term'];
			$vd_send_form_customer_message_text .= "\r\nВ бизнес-центре: " . $MY_POST['business_center'];
/*			$vd_send_form_customer_message_text .= "\r\nСтоимость: " . $MY_POST['virtual_office_price'];*/
			...
			if (true === mail_send($manager_email, 'Заявка на услуги виртуального офиса', $vd_send_form_manager_message_text)) {
				mail_send($MY_POST['email'], 'Ваша заявка принята',
					strip_tags(htmlspecialchars_decode($vd_send_form_customer_message_text)) . "\r\n\r\n\r\n\r\n" .
					htmlspecialchars_decode($_SITE['settings']['client_email_footer']));
				echo 'Спасибо, ваша заявка на услуги виртуального офиса принята.';
			...
			$vd_send_form_manager_message_text .= "\r\nКлиент бронирует: " . $MY_POST['meeting_rate'];
			$vd_send_form_manager_message_text .= "\r\nБизнес-центр: " . $MY_POST['business_center'];
/*			$vd_send_form_manager_message_text .= "\r\nСтоимость: " . $MY_POST['meeting_price'];*/
			
			$vd_send_form_manager_message_text .= "\r\nДата: " . date('Y-m-d', strtotime($MY_POST['date']));
			$vd_send_form_manager_message_text .= "\r\nВремя: " . $MY_POST['meeting_time'];
			$vd_send_form_manager_message_text .= "\r\nПродолжительность встречи: " . $MY_POST['meeting_duration'];
			$vd_send_form_manager_message_text .= "\r\nНужно дополнительное обслуживание: " . ($MY_POST['additionalservice']?'Да':'Нет');

			$additionalservice_options_text = '';
			if ($MY_POST['additionalservice'] && $MY_POST['additionalservice-option']) {
				foreach ($MY_POST['additionalservice-option'] as $additionalservice_option) {
					$additionalservice_options_text .= $additionalservice_option . '; ';
				}
				$additionalservice_options_text = ' (' . rtrim($additionalservice_options_text, '; ') . ')';

				$vd_send_form_manager_message_text .= $additionalservice_options_text;
			}
			...
			$vd_send_form_customer_message_text .= "Здравствуйте, " . $MY_POST['name'] . "\r\n\r\nВаша заявка на бронирование переговорной принята.\r\nДля подтверждения бронирования наш менеджер свяжется с Вами в рабочее время по будням с 10.00 до 19.00";
			
			$vd_send_form_customer_message_text .= "\r\n";
			
			$vd_send_form_customer_message_text .= "\r\nВы бронируете: " . $MY_POST['meeting_rate'];
			$vd_send_form_customer_message_text .= "\r\nВ бизнес-центре: " . $MY_POST['business_center'];
/*			$vd_send_form_customer_message_text .= "\r\nСтоимость: " . $MY_POST['meeting_price'];*/
			...
			$vd_send_form_customer_message_text .= "\r\nПродолжительность встречи: " . $MY_POST['meeting_duration'];
			$vd_send_form_customer_message_text .= "\r\nНужно дополнительное обслуживание: " . ($MY_POST['additionalservice']?'Да':'Нет');
			$vd_send_form_customer_message_text .= $additionalservice_options_text;
			$vd_send_form_customer_message_text .= "\r\n";
...
/*			if ($customer_warning = $_DATA['office_center_room']['items'][$MY_POST['business_center_room_id']]['comment3']) {
				$vd_send_form_customer_message_text .= "\r\n\r\n\r\nОбратите внимание! " . str_replace('&nbsp;', ' ', htmlspecialchars_decode(strip_tags($customer_warning)));
			}*/

			if (true === mail_send($manager_email, 'Заявка на переговорную', $vd_send_form_manager_message_text)) {
				mail_send($MY_POST['email'], 'Ваша заявка принята',
					strip_tags(htmlspecialchars_decode($vd_send_form_customer_message_text)) . "\r\n\r\n\r\n\r\n" .
					htmlspecialchars_decode($_SITE['settings']['client_email_footer']));
				echo 'Спасибо, ваша заявка на бронирование переговорной принята.';
				...
				$db_data = array(
					...
					'email' => $MY_POST['email'],
					'phone' => $MY_POST['phone'],
					'message' => ($additionalservice_options_text?'Нужно дополнительное обслуживание:' . $additionalservice_options_text . "\r\n\r\n":'') . $MY_POST['message'],
			...
			$is_one_seat = (1 == $MY_POST['coworking_workplaces']);
			
			$vd_send_form_manager_message_text .= "Здравствуйте,\r\n\r\nНа сайте была оформлена новая заявка на бронирование мест" . ($is_one_seat?'а':'') . " в коворкинге.";
			
			$vd_send_form_manager_message_text .= "\r\n";
			
			$vd_send_form_manager_message_text .= "\r\nКлиент бронирует: " . $MY_POST['coworking_workplaces'] . ' ' . text_format_quantity_ru($MY_POST['coworking_workplaces'], array('место', 'места', 'мест'));
...
/*			$vd_send_form_manager_message_text .= "\r\nСтоимость: " . $MY_POST['coworking_price'];*/
			...
			$vd_send_form_customer_message_text .= "Здравствуйте,\r\n\r\nВаша заявка на бронирование мест" . ($is_one_seat?'а':'') . " в коворкинге принята.";
			
			$vd_send_form_customer_message_text .= "\r\n";
			
			$vd_send_form_customer_message_text .= "\r\nВы бронируете: " . $MY_POST['coworking_workplaces'] . ' ' . text_format_quantity_ru($MY_POST['coworking_workplaces'], array('место', 'места', 'мест'));
			$vd_send_form_customer_message_text .= "\r\nТариф: " . $MY_POST['coworking_rate'];
			$vd_send_form_customer_message_text .= "\r\nВ бизнес-центре: " . $MY_POST['business_center'];
/*			$vd_send_form_customer_message_text .= "\r\nСтоимость: " . $MY_POST['coworking_price'];*/
			...
			if (true === mail_send($manager_email, 'Заявка на коворкинг', $vd_send_form_manager_message_text)) {
				mail_send($MY_POST['email'], 'Ваша заявка принята',
					strip_tags(htmlspecialchars_decode($vd_send_form_customer_message_text)) . "\r\n\r\n\r\n\r\n" .
					htmlspecialchars_decode($_SITE['settings']['client_email_footer']));
				echo "Спасибо, ваша заявка на бронирование мест" . ($is_one_seat?'а':'') . " в коворкинге принята.";
			...
			<div class="vd_serviceincenter_wrapper-freeoffices-list">
				...
				<div class="vd_serviceincenter_wrapper-freeoffices-list-element">
					<div class="vd_serviceincenter_wrapper-freeoffices-list-element-header">
						<a href="<? echo $single_office_center_room['img_src_big']; ?>" target="_blank" class="vd_serviceincenter_wrapper-freeoffices-list-element-header-office">
							<img src="<? echo $single_office_center_room['img_src']; ?>">
							<span><? echo $single_office_center_room['title']; ?></span>
						</a>
					<? /*	--- worked ok, commented out per client request
						...
						<div class="vd_serviceincenter_wrapper-freeoffices-list-element-header-price">
							<div class="reserve">ЗАКАЗАТЬ ПРОСМОТР</div>
							...
							<? /*	<div class="vd_serviceincenter_wrapper-freeoffices-list-element-menu-previewform-right-preview">
								...
								<div class="vd_serviceincenter_wrapper-freeoffices-list-element-menu-previewform-right-datetime">
									<label class="date_label">Выберите дату просмотра <input type="text" name="date" class="date" placeholder="Выберите дату"></label><label class="time_label">Время просмотра <select class="time" name="time">
										...
										<option selected="selected">10.00 – 11.00</option>
								...
								<div class="serviceincente-book">
									<button>ЗАБРОНИРОВАТЬ</button>
									<div class="warning">Обратите внимание! Услуга бронируется <span>только</span> до конца следующего дня</div>
								</div>
								<div class="serviceincenter-preview">
									<button class="vd_serviceincenter_wrapper-freeoffices-list-element-menu-previewform-right-submit">
										ЗАКАЗАТЬ ПРОСМОТР
									</button>
								</div>
							</div>	
				...
				<div class="vd_serviceincenter_wrapper-virtualrates-list-forms">
					...
					<div class="vd_serviceincenter_wrapper-virtualrates-list-form" data-virtual-form="<? echo $single_virtual_office['id']; ?>">
						<form method="post" action="">
							...
							<input type="hidden" name="business_center" value="<? echo $_DATA['office_center']['items'][$g_office_center_id]['title']; ?>" />
							<input type="hidden" name="business_center_id" value="<? echo $g_office_center_id; ?>" />
				...
				<div class="vd_serviceincenter_wrapper-meetingrates-list-item">
					<form method="post" action="">
						...
						<div class="vd_serviceincenter_wrapper-meetingrates-list-item-header">
							<a href="<? echo $single_metting_office['img_src_big']; ?>" class="vd_serviceincenter_wrapper-meetingrates-list-item-header-photo" target="_blank">
							...
							<div class="vd_serviceincenter_wrapper-meetingrates-list-item-header-area">
								<? echo (int)$single_metting_office['floor_area_m2']; ?> кв. м
							</div>
						...
						<div class="vd_serviceincenter_wrapper-meetingrates-list-item-form">
							...
							<div class="vd_serviceincenter_wrapper-meetingrates-list-item-form-right">
								...
								<input type="text" class="name" name="name" placeholder="Имя">
								<textarea class="message" name="message" placeholder="Ваше сообщение"></textarea>
								<button class="meeting_submit">Забронировать переговорную</button>
							<? /*	<button class="disabled consultation" data-url="<?=$_SITE['section_paths']['request']['path']?>">Получить консультацию</button> */ ?>
							</div>
							<div class="vd_serviceincenter_wrapper-meetingrates-list-item-form-left">
								...
								<div class="vd_serviceincenter_wrapper-meetingrates-list-item-form-left-item">
									<div class="vd_serviceincenter_wrapper-meetingrates-list-item-form-left-item-widecontrols">
										...
										<?	$meeting_start_hours = explode("\n", trim($_SITE['settings']['booking_meeting_hours']));
											foreach ($meeting_start_hours as $start_hour) { ?>
												<option><?=trim($start_hour)?></option>
										<?	} ?>
										</select>
							...
							<? /*
								...
								<div class="vd_serviceincenter_wrapper-meetingrates-list-item-form-left-item">
									<div class="vd_serviceincenter_wrapper-meetingrates-list-item-form-left-item-widetall g-clearfix">
									...
									<div class="additionalservice-options" style="display: none;">
										<?	$booking_meeting_extras = explode("\n", trim($_SITE['settings']['booking_meeting_extras']));
											foreach ($booking_meeting_extras as $meeting_extra) { ?>
												<label class="additionalservice_label g-clearfix"><input type="checkbox" name="additionalservice-option[]" class="additionalservice" value="<?=trim($meeting_extra)?>"><span></span><?=trim($meeting_extra)?></label>
										<?	} ?>
									</div>
								</div>
							</div>
